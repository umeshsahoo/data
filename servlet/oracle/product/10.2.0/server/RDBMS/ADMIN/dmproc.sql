Rem 
Rem $Header: dmproc.sql 22-oct-2004.10:47:25 pstengar Exp $
Rem
Rem dmproc.sql
Rem 
...
--         PACKAGE SYNONYMS
CREATE OR REPLACE PUBLIC SYNONYM odm_ABN_model FOR dmsys.odm_ABN_model
/
CREATE OR REPLACE PUBLIC SYNONYM odm_attribute_importance_model FOR dmsys.odm_attribute_importance_model
/
CREATE OR REPLACE PUBLIC SYNONYM odm_association_rule_model FOR dmsys.odm_association_rule_model
/
CREATE OR REPLACE PUBLIC SYNONYM odm_clustering_util FOR dmsys.odm_clustering_util
/
CREATE OR REPLACE PUBLIC SYNONYM odm_model_util FOR dmsys.odm_model_util
/
CREATE OR REPLACE PUBLIC SYNONYM odm_naive_bayes_model FOR dmsys.odm_naive_bayes_model
/
CREATE OR REPLACE PUBLIC SYNONYM odm_oc_clustering_model FOR dmsys.odm_oc_clustering_model
/
CREATE OR REPLACE PUBLIC SYNONYM odm_util FOR dmsys.odm_util
/
