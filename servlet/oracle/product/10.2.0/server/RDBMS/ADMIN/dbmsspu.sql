Rem
Rem $Header: dbmsspu.sql 17-nov-2005.10:19:30 nmukherj Exp $
Rem
Rem dbmsspu.sql
Rem
...
Rem    nmukherj    11/09/05 - added databse_shrink and
Rem                           and tablespace shrink for XE
...
create or replace package dbms_space AUTHID CURRENT_USER as
 ...
 -- tablespace level shrink --


  procedure tablespace_level_shrink(ts_name in varchar2);

  -- database level shrink --

  procedure database_level_shrink;
