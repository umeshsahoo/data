rem 
rem $Header: dbmspexp.sql 24-sep-2004.05:17:01 kamble Exp $ 
rem 
...
-- is empty.
  ...
  PROCEDURE set_imp_flush_shared_pool;
...
-- RETURNS: varchar value converted from long
