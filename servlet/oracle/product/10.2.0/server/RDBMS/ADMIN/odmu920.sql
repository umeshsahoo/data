...
execute sys.dbms_registry.upgrading('ODM',NULL,'validate_odm',NULL);

@@dminst.sql SYSAUX TEMP

Rem Add ODM component into registry with new DMSYS schema
execute sys.dbms_registry.upgrading('ODM',NULL,'validate_odm','DMSYS');

ALTER SESSION SET CURRENT_SCHEMA = "SYS";

Rem Load DM validation procedure into SYS
@@odmproc.sql
