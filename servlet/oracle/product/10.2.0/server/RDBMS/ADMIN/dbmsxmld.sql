Rem
Rem $Header: dbmsxmld.sql 11-may-2004.13:13:10 rxpeters Exp $
Rem
Rem dbmsxmld.sql
Rem
...
-- DOM interface types
--
SUBTYPE domtype IS RAW(12);

TYPE DOMNode IS RECORD (id RAW(12));
TYPE DOMNamedNodeMap IS RECORD (id RAW(12));
TYPE DOMNodeList IS RECORD (id RAW(12));
TYPE DOMAttr IS RECORD (id RAW(12));
TYPE DOMCDataSection IS RECORD (id RAW(12));
TYPE DOMCharacterData IS RECORD (id RAW(12));
TYPE DOMComment IS RECORD (id RAW(12));
TYPE DOMDocumentFragment IS RECORD (id RAW(12));
TYPE DOMElement IS RECORD (id RAW(12));
TYPE DOMEntity IS RECORD (id RAW(12));
TYPE DOMEntityReference IS RECORD (id RAW(12));
TYPE DOMNotation IS RECORD (id RAW(12));
TYPE DOMProcessingInstruction IS RECORD (id RAW(12));
TYPE DOMText IS RECORD (id RAW(12));
TYPE DOMImplementation IS RECORD (id RAW(12));
TYPE DOMDocumentType IS RECORD (id RAW(12));
