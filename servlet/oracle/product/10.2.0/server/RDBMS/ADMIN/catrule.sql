Rem
Rem $Header: catrule.sql 13-dec-2004.10:10:08 ksurlake Exp $
Rem
Rem catrule.sql
Rem
...
/
CREATE or replace TYPE BODY sys.re$nv_list AS
...
AS VARRAY(1024) OF sys.re$variable_type
/
...
AS VARRAY(1024) OF sys.re$variable_value
/
...
AS VARRAY(1024) OF sys.re$rule_hit
/
