Rem
Rem $Header: xdbs101.sql 12-apr-2005.16:41:05 rpang Exp $
Rem
Rem xdbs101.sql
Rem
...
Rem This first set of packages should be loaded when the schema upgrades
Rem finish. This statement should be moved to the end of xdbs10*.sql when
Rem that new script has been created.
@@xdbptrl1.sql
