Rem
Rem $Header: dbmscdcu.sql 20-nov-2004.19:42:47 twtong Exp $
Rem
Rem dbmscdcu.sql
Rem
...
Rem
  ...
  IS
	...
	change_table_type    IN VARCHAR2,
     ...
     -- If submits a job, returns the job number else zero.
     --
     PROCEDURE check_purge ( jobno OUT NUMBER );
     ...
     --
     -- Verify the varchar/char paramter does not exceed the limit
     --
