Rem
Rem $Header: catxdbpi.sql 13-apr-2004.11:07:37 abagrawa Exp $
Rem
Rem catxdbpi.sql
Rem
...
create or replace package xdb.XDB_PITRIG_PKG as
  ...
  procedure pitrig_delmetadata(owner varchar2, name varchar2, deloid raw, tbloid raw, resid raw, cuser varchar2);
  procedure pitrig_updmetadata(owner varchar2, name varchar2, deloid raw, tbloid raw, resid raw, cuser varchar2);
