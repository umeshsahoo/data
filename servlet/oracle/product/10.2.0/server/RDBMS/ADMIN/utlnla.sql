Rem
Rem $Header: utlnla.sql 31-may-2005.11:54:03 lvbcheng Exp $
Rem
Rem utlnla.sql
Rem
...
Rem    lvbcheng    05/31/05 - Documentation review 
...
CREATE OR REPLACE TYPE UTL_NLA_ARRAY_DBL is 
  VARRAY(1000000) OF BINARY_DOUBLE  NOT NULL;
/
CREATE OR REPLACE TYPE UTL_NLA_ARRAY_FLT is 
  VARRAY(1000000) OF BINARY_FLOAT   NOT NULL;
/
CREATE OR REPLACE TYPE UTL_NLA_ARRAY_INT is 
  VARRAY(1000000) OF INTEGER        NOT NULL;
/
...
CREATE OR REPLACE PACKAGE UTL_NLA as
  ...
  -- =======   
  --
  -- BLAS_SWAP swaps the contents of two vectors each of size n.
  --
  -- Arguments   
  -- =========   
  --
  -- N      - INTEGER.   
  --          On entry, N specifies the number of elements of the 
  --          vectors X and Y.   
  ...
  --
  -- N      - INTEGER.   
  --          On entry, N specifies the number of elements of the vectors 
  --          X and Y.   
  --          N must be at least zero.   
  --          Unchanged on exit. 
  ...
  --  =======
  --
  --  LAPACK_SYEV computes all eigenvalues and, optionally, eigenvectors of a
  ...
  --  =======
  --
  --  LAPACK_SBEVD computes all the eigenvalues and, optionally, eigenvectors 
  --  of a real symmetric band matrix A. If eigenvectors are desired, it uses
