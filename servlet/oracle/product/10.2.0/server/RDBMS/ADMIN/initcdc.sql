Rem
Rem $Header: initcdc.sql 16-aug-2005.12:02:02 mbrey Exp $
Rem
Rem initcdc.sql
Rem
...
Rem    mbrey       08/16/05 - bug 4555922 insert datapump calls 
Rem    mbrey       08/02/05 - bug 4531051 - adding CDC packages 
...
REM Load change data capture packages (done through catjava.sql)
REM prvtcdcu calls into prvtcdcp
REM NOTE: dependant on  Streams packages
REM NOTE: dependant on  Data Pump packages
REM NOTE: dependant on  internal trigger package
REM NOTE: if above packages not loaded first, will get errors
@@dbmscdcu.sql
@@dbmscdcp.sql
@@dbmscdcs.sql
@@prvtcdcu.plb
