Rem
Rem $Header: dbmspp.sql 23-aug-2004.17:02:20 mxyang Exp $
Rem
Rem dbmspp.sql
Rem
...
create or replace package dbms_preprocessor authid current_user as
  ...
  --     is generated.
  --  3. For a valid wrapped PL/SQL unit, its original wrapped source will
  --     be used as the post-processed source.
  -------------
  -- TYPES
  --
