Rem
Rem $Header: exfu101.sql 07-may-2005.07:54:28 ayalaman Exp $
Rem
Rem exfu101.sql
Rem
...
---bug 4114159 ---
revoke execute on ExpressionIndexMethods from public;
revoke execute on ExpressionIndexStats from public;
revoke execute on exfsys.EVALUATE_VV from public;
revoke execute on exfsys.EVALUATE_VA from public;
revoke execute on exfsys.EVALUATE_CV from public;
revoke execute on exfsys.EVALUATE_CA from public;


REM
REM  Call the upgrade script for next release (None)
REM 
