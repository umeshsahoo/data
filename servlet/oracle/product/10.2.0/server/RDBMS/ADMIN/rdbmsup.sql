Rem
Rem $Header: rdbmsup.sql 31-may-2005.07:24:50 rburns Exp $
Rem
Rem rdbmsup.sql
Rem
...
DECLARE
   rdbmsup_version CONSTANT v$instance.version%type := '10.2.0.0';
...
BEGIN
   ...
   IF rerun THEN  -- no MIGRATE_SID directive; ignore re-run errors
      DBMS_OUTPUT.PUT_LINE('ODMA_DIRECTIVE:VERSION:'||vers);
