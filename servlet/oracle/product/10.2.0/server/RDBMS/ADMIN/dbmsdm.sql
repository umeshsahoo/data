Rem
Rem $Header: dbmsdm.sql 07-feb-2005.15:11:22 mmcracke Exp $
Rem
Rem dbmsdm.sql
Rem
...
Rem      must be created under DMSYS. Operations provided by this package
...
CREATE OR REPLACE PACKAGE dbms_data_mining AUTHID CURRENT_USER AS
  ...
  -- FUNCTION NAME (input as BUILD parameter)
  --
  ...
  FUNCTION get_association_rules(model_name       IN VARCHAR2,
                                 ...
                                 antecedent_items IN ORA_MINING_VARCHAR2_NT DEFAULT NULL,
                                 consequent_items IN ORA_MINING_VARCHAR2_NT DEFAULT NULL)
  ...
  --FUNCTION get_model_details_km (model_name IN VARCHAR2)
  ...
  --FUNCTION get_model_details_oc (model_name IN VARCHAR2)
  --RETURN dm_clusters PIPELINED;
  ...
  FUNCTION get_model_details_svm(model_name IN VARCHAR2)
...
/
CREATE OR REPLACE PUBLIC SYNONYM dbms_data_mining FOR dmsys.dbms_data_mining
/
