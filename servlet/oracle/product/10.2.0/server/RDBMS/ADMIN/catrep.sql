Rem 
rem $Header: catrep.sql 14-nov-2000.19:37:52 lkaplan Exp $ 
rem 
...
Rem pl/sql packages necessary for snapshots
@@catreps

Rem pl/sql packages necessary for masters 
Rem comment out the next line for snapshot only functionality
Rem note that the catreps script is always required
@@catrepm

Rem IAS packages and scripts installed out of catias file.
Rem must be run after all replication scripts.
@@catias
