Rem 
Rem $Header: odmcrt.sql 25-oct-2004.19:57:21 xbarr Exp $ template.tsc 
Rem 
...
INSERT INTO exppkgact$ (package, schema, class, level#)
        VALUES ('DBMS_DM_MODEL_EXP', 'DMSYS', 2, 2000);
INSERT INTO exppkgact$ (package, schema, class, level#)
        VALUES ('DBMS_DM_MODEL_EXP', 'DMSYS', 3, 4000);
INSERT INTO exppkgact$ (package, schema, class, level#)
        VALUES ('DBMS_DM_MODEL_EXP', 'DMSYS', 6, 1000);

Rem  Required for writing trace files

GRANT EXECUTE ON sys.dbms_system TO DMSYS;

GRANT SELECT, INSERT, DELETE, UPDATE ON sys.expdepact$ TO DMSYS;
