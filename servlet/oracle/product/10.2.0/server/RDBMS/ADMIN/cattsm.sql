Rem
Rem $Header: cattsm.sql 29-oct-2004.10:25:14 mbastawa Exp $
Rem
Rem cattsm.sql
Rem
...
-- Create TSMSYS schema. Use default tablespaces (usually SYSTEM) for now. 
-- Note please re-lock the account if you need to connect to tsmsys. 
create user TSMSYS identified by TSMSYS ACCOUNT LOCK PASSWORD EXPIRE;

-- to create tables
grant resource to TSMSYS; 

-----------------------------------------------
-- Begin invoking component specific scripts here
-----------------------------------------------

-- Add creation of cursor component objects here
@@cattsmcr.sql
