Rem
Rem $Header: xdbu9202.sql 08-feb-2005.18:44:05 vkapoor Exp $
Rem
Rem xdbu9202.sql
Rem
...
revoke select any table from xdb;
...
DECLARE
  ...
  ct     NUMBER;
BEGIN
  select count(*) into ct from resource_view where any_path = '/sys/apps';
  IF ct = 0 then
...
Rem Repeatable, does not use status.
begin
  IF NOT dbms_xdbz0.is_hierarchy_enabled_trig('XDB', 'XDB$CONFIG') THEN
