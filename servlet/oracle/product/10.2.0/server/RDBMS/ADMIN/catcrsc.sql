Rem
Rem $Header: catcrsc.sql 08-nov-2004.07:21:10 rburns Exp $
Rem
Rem catcrsc.sql
Rem
...
WK_path       CONSTANT VARCHAR2(50) := '?/ultrasearch/admin/';
...
HTMLDB_path   CONSTANT VARCHAR2(50) := '?/htmldb/core/';
...
HTMLDB_prefix   CONSTANT VARCHAR2(3) := 'htm';
...
HTMLDB_option   CONSTANT VARCHAR2(30) := NULL;
