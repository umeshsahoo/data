...
Rem
Rem    NOTES
Rem      - DBMS_DDL.ALTER_COMPILE is deprecated as of 10.2 in favor of
Rem      ALTER PROCEDURE|FUNCTION|PACKAGE [<schema>.]
Rem         <name> COMPILE [BODY] ?REUSE SETTINGS?.
Rem     
Rem      While the procedure will remain in the package, users are
Rem      advised to depend on the above DDL in combination with
Rem      dynamic SQL to obtain the same functionality in their PL/SQL
Rem      application.
Rem
...
Rem    lvbcheng    06/14/05 - deprecate dbms_ddl.alter_compile 
...
create or replace package dbms_ddl AUTHID CURRENT_USER is
  ...
  --
  -- NOTE:
  -- This procedure is deprecated as of 10.2 in favor of
  --   "ALTER PROCEDURE|FUNCTION|PACKAGE [<schema>.]
  --      <name> COMPILE [BODY] ?REUSE SETTINGS?".
  --
