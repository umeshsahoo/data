Rem
Rem $Header: dbmsuri.sql 22-mar-2005.15:12:08 jwwarner Exp $
Rem
Rem dbmsuri.sql
Rem
...
grant under on Uritype to PUBLIC with grant option;
...
grant execute on UriFactory to PUBLIC with grant option;
