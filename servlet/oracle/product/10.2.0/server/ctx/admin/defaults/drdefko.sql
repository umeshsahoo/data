Rem
Rem $Header: drdefko.sql 20-nov-2001.12:37:48 gkaminag Exp $
Rem
Rem drdefko.sql
Rem
...
begin
  CTX_DDL.create_preference('DEFAULT_LEXER','KOREAN_MORPH_LEXER');
end;
/
...
begin
  ...
  CTX_DDL.set_attribute('DEFAULT_WORDLIST','FUZZY_MATCH', 'KOREAN');
end;
/
